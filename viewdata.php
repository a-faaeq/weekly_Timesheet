...
<html lang="en">
 ...
 <link href="css/timesheet.css" rel="stylesheet">
    <title>View_TimeSheets</title>
   
  </head>
  <body class="text-center">
      
      
    <form class="form-signin" method="post" action="view_data.php" id="form">
    ...
    <h1>C&T Home Care</h1>
     ...
     <label for="payroll" class="">Payroll ID</label>
      <input type="text" id="payroll" name="payroll"  class="form-control" placeholder="Please Enter Payroll ID" required>
      <div class="checkbox mb-3">
        
      </div>
      <button class="btn btn-lg btn-primary btn-block my-2" type="submit">Submit</button>
      <a href='https://candthomecare.us/timesheet/timesheet_history1.php' style="text-decoration:none"><button class="btn btn-lg btn-warning btn-block" type="button">Click To See History</button></a>
