...
<body>
		...
		$result = mysqli_query($conn, "select * from view where payroll like '$payroll' and qb like '$qbid'ORDER BY view.id DESC LIMIT 1 ");
		$result1=mysqli_query($conn,"select * from view where payroll like '$payroll' and qb like '$qbid'");
        $row1 = mysqli_fetch_assoc($result1);
         
        


		if ($result && $row1 && $result1) {
